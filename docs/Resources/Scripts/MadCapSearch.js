...
(function () {
    ...
    SearchDB.prototype.LoadStemmer = function (language, OnCompleteFunc) {
        ...
        if (language != null && supportedLanguages.indexOf(language.toLowerCase()) != -1) {
            ...
            var scriptFolder = MadCap.Utilities.HasRuntimeFileType("SkinPreview") ?
                    ...
                    this.HelpSystem.GetPath() + "Resources/Scripts/";
    ...
    SearchDB.prototype.LoadTopic = function (topicId) {
        ...
        if (chunkId == -1)
            ...
            MadCap.Utilities.Require([this.HelpSystem.GetPath() + "Data/SearchTopic_Chunk" + chunkId], function (data) {
    ...
    SearchDB.prototype.LoadUrl = function (url) {
        ...
        if (chunkId == -1)
            ...
            MadCap.Utilities.Require([this.HelpSystem.GetPath() + "Data/SearchUrl_Chunk" + chunkId], function (data) {
    ...
    SearchDB.prototype.LoadStemChunk = function (chunkId) {
        ...
        MadCap.Utilities.Require([this.HelpSystem.GetPath() + "Data/SearchStem_Chunk" + chunkId], function (data) {
    ...
    SearchDB.prototype.LoadPhrase = function (phrase, topicId) {
        ...
        MadCap.Utilities.Require([this.HelpSystem.GetPath() + "Data/SearchPhrase_Chunk" + chunkId], function (data) {
            var phraseObj;
            if (data[phrase])
        ...
        function AppendParams(query, params) {
            ...
            for (var i = 0; i < params.length; i++) {
                ...
                if (!MadCap.String.IsNullOrEmpty(val)) {
                    query += (hasParam ? "&" : "?") + name + "=" + encodeURIComponent(val);
                    hasParam = true;
                }
            }
    ...
    Search.SearchResult = function (score, title, link, abstractText) {
        // Public properties
